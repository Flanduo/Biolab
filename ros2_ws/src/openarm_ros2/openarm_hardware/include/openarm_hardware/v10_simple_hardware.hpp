...
class OpenArm_v10HW : public hardware_interface::SystemInterface {
 ...
 private:
  ...
  // Default gains
  const std::vector<double> DEFAULT_KP = {80.0, 40.0, 40.0, 80.0,
                                          20.0,  25.0,  45.0,  0.5};
  ...
  const double GRIPPER_DEFAULT_KP = 15.0;
  const double GRIPPER_DEFAULT_KD = 1;
  ...
  bool hand_;
  bool can_fd_;
  bool enable_tau_ff_test_ = false;
  std::vector<double> tau_ff_test_offsets_;
  std::vector<double> tau_ff_limits_;
