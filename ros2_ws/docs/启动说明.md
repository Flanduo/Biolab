...
注意：如果没有连接真实机械臂必须运行`ros2 launch openarm_bimanual_moveit_config demo.launch.py arm_type:=v10` 会显示显示坐标转换错误，注意添加`arm_type:=v10 use_fake_hardware:=true`
